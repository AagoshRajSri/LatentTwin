...
export default function ParticleWave({
  messages = [
    ...
    "Following incoming dependencies",
    ...
    function draw() {
      ...
      for (let row = 0; row < ROWS; row++) {
        ...
        for (let col = 0; col < COLS; col++) {
          ...
          const ph1 = col * 0.4 - t * 2.2 + row * 0.25;
          const ph2 = col * 0.25 + t * 1.5 - row * 0.18;
          const ph3 = col * 0.6 - t * 0.8 + row * 0.55;
          ...
          const dy =
            Math.sin(ph1) * amp1 + Math.sin(ph2) * amp2 + Math.cos(ph3) * amp3;
          ...
          const colorNorm =
            (((colNorm + (ph1 / (Math.PI * 2)) * 0.3) % 1) + 1) % 1;
  ...
  return (
    <div
      style={{
        ...
        zIndex: 9999,
        background:
          "radial-gradient(ellipse at 50% 50%, #080d1c 0%, #020509 100%)",
        display: "flex",
        alignItems: "center",
